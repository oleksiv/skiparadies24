...
(async () => {
    ...
    for (let category of CATEGORIES) {
        ...
        await browserPage.goto(`https://www.sport-hopfmann.de/wintersport-sport/${category}/?listorderby=oxvarminprice&listorder=desc`);
        ...
        for (const product of skiProducts) {
            ...
            productVariants.push(productDetails);
            ...
            detailedProductData.push(productVariants);
        }
